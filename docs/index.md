# Гайдбук Факультету Прикладних Наук УКУ
...
## Посібник з використання фірмового стилю

**Факультет прикладних наук** · Український Католицький Університет

<div class="hero-buttons" markdown>
[:material-image: Логотипи](logos/index.md){ .md-button }
[:material-palette: Кольори](brand/colors.md){ .md-button }
[:material-format-font: Шрифти](brand/fonts.md){ .md-button }
[:material-download: Завантажити](assets/downloads.md){ .md-button .md-button--primary }
</div>
...
Логотип Applied Sciences Faculty є основним ідентифікатором факультету. Він складається з декоративного елементу (хвиляста лінія з хрестиком) та напису.
...
- :material-book-open-variant:{ .lg .middle } **Правила використання**
    ...
    ***
    ...
    [:octicons-arrow-right-24: Детальніше](brand/guidelines.md)

</div>

### DataX Logo

Логотип програми DataX — освітньої ініціативи факультету у сфері Data Science.

[:octicons-arrow-right-24: Переглянути DataX Logo](logos/datax-logo.md)

---

## Колористика

Фірмова палітра складається з двох основних та чотирьох допоміжних кольорів.

### Основні кольори

<div class="color-grid" markdown>

<div class="color-card purple" markdown>
<div class="color-swatch"></div>
<div class="color-info" markdown>
**Фіолетовий**
...
<div class="color-card green" markdown>
<div class="color-swatch"></div>
<div class="color-info" markdown>
**Зелений**
...
Альтернативний шрифт для презентацій.

[:octicons-arrow-right-24: Повна документація шрифтів](brand/fonts.md)
...
- :material-certificate:{ .lg .middle } **Сертифікати**
    ...
    ***
    ...
    [:octicons-arrow-right-24: Переглянути](corporate/certificates.md)
