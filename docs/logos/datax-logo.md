...
!!! info "Коли використовувати"
    - Матеріали програми DataX
    - Сертифікати випускників DataX
    - Промо-матеріали курсів з Data Science
    - Соціальні мережі програми

!!! warning "Обмеження"
    - Логотип DataX використовується тільки для матеріалів, пов'язаних з програмою
    - При використанні поруч з логотипом факультету — логотип факультету має бути більшим
