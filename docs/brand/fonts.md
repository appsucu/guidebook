...
<div class="type-example" style="background: linear-gradient(135deg, #662d91 0%, #8b5cf6 100%); color: white; padding: 2rem; border-radius: 12px; margin: 1.5rem 0;">
...
<div class="type-example" style="background: #f8f9fa; padding: 2rem; border-radius: 12px; border-left: 4px solid #662d91; margin: 1.5rem 0;">
  <p style="font-family: 'Inter', sans-serif; font-size: 1.5rem; font-weight: 500; color: #333; margin: 0;">Master's Symposium on Advances in Data Mining, Machine Learning, and Computer Vision</p>
</div>
