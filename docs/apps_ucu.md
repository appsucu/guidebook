...
## Чому варто обрати Факультет прикладних наук?
...
<div class="logo-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem; margin: 2rem 0;">

<div style="background: #ffffff; padding: 2rem; border-radius: 12px; text-align: center; border: 1px solid #e5e7eb;">
  <img src="/guidebook/assets/logo/logo_aps_eng_full_color.svg" alt="APPS Logo Light" style="max-width: 200px;">
  <p style="margin: 1rem 0 0 0; color: #666; font-size: 0.875rem;">Для світлого фону</p>
</div>

<div style="background: #1a1a2e; padding: 2rem; border-radius: 12px; text-align: center;">
  <img src="/guidebook/assets/logo/logo_aps_eng.svg" alt="APPS Logo Full Color" style="max-width: 200px;">
  <p style="margin: 1rem 0 0 0; color: #ccc; font-size: 0.875rem;">Повноколірний</p>
</div>
